...
import { IoShirtOutline, IoCutOutline, IoColorWandOutline } from 'react-icons/io5';
import './Features.css';
        ...
        <div className="features-grid">
          <div className="feature-card">
            <div className="feature-icon-wrapper">
              <IoShirtOutline size={32} className="feature-icon" />
            </div>
          ...
          <div className="feature-card">
            <div className="feature-icon-wrapper">
              <IoCutOutline size={32} className="feature-icon" />
            </div>
          ...
          <div className="feature-card">
            <div className="feature-icon-wrapper">
              <IoColorWandOutline size={32} className="feature-icon" />
            </div>
